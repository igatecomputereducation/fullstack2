...
app.post("/usravl",function(req,res){
    usersdao.usravl(req.body.username,req.body.password)
    .then(function(data){
        res.send(data);
    })
    .catch(function(err){
...
app.patch("/modusr",function(req,res){
    usersdao.modusr(req.body.username,req.body.newpassword)
    .then(function(msg){
        res.send(msg);
    })
    .catch(function(err){
